...
var Triangle = // not in use, can be description of a triangle type

// when adding new triangle types, include .png image with the same name in /image folder
...
var calculateTriangle = function calculateTriangle(sideA, sideB, sideC) {
...
var TriangleChecker = function (_React$Component) {
	_inherits(TriangleChecker, _React$Component);

	function TriangleChecker() {
		_classCallCheck(this, TriangleChecker);

		var _this = _possibleConstructorReturn(this, (TriangleChecker.__proto__ || Object.getPrototypeOf(TriangleChecker)).call(this));
	...
	_createClass(TriangleChecker, [{
		...
		key: 'validateField',
		value: function validateField(name, val) {
			var errors = {};
			var isValid = true;
		...
		value: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'form',
					{ 'data-ts': 'Form', className: 'ts-form', action: 'javascript:void(false);' },
					React.createElement(
						'fieldset',
						{ className: 'ts-fieldset' },
						React.createElement(
							'label',
							null,
							React.createElement(
							...
							React.createElement('input', { type: 'number', name: 'a', value: this.state.fields.a, onChange: this.handleChange })
						),
						React.createElement(
							'div',
							{ className: 'errorMsg' },
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement('input', { type: 'number', name: 'b', value: this.state.fields.b, onChange: this.handleChange })
						),
						React.createElement(
							'div',
							{ className: 'errorMsg' },
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement('input', { type: 'number', name: 'c', value: this.state.fields.c, onChange: this.handleChange })
						),
						React.createElement(
							'div',
							{ className: 'errorMsg' },
					...
					triangle.name.length > 0 ? React.createElement(
						'button',
						{ 'data-ts': 'Button', 'class': 'ts-primary', onClick: this.clear },
						React.createElement(
							'span',
							null,
							'Clear'
				...
				React.createElement(
					...
					React.createElement(
						'div',
						null,
						React.createElement('img', { className: 'ts-userimage', src: triangle.image, alt: triangle.alt }),
						React.createElement(
							'label',
							null,
							triangle.name
...
var App = createReactClass({
	...
	render: function render() {
		return React.createElement(
			'div',
			null,
			React.createElement(Header, { title: 'Triangle checker' }),
			React.createElement(TriangleChecker, null)
		);
	}
});
